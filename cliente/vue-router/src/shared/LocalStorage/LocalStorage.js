...
export const escribeLocalStorage = ( clave, valor ) => localStorage.setItem(clave, valor)
...
export const estaPermitidoAalgunos = (to, from, next) => estaPermitido() ? next() : next({name:'SubMenu 2'})
